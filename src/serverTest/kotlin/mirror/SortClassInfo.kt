...
object SortClassInfo: ClassInfo<Sort<*>> {
    ...
    override val implements: List<Type<*>> = listOf(Type<kotlin.Comparator<Any?>>(kotlin.Comparator::class, listOf(TypeProjection(Type<Any?>(Any::class, listOf(), false), TypeProjection.Variance.INVARIANT)), false))
