...
object SuspendMapRemoveRequestClassInfo: ClassInfo<SuspendMapRemoveRequest<*,*>> {

    override val kClass: KClass<SuspendMapRemoveRequest<*,*>> = SuspendMapRemoveRequest::class
    ...
    override val name: String = "SuspendMapRemoveRequest"
    override val annotations: List<AnnotationInfo> = listOf()
    override val enumValues: List<SuspendMapRemoveRequest<*,*>>? = null

    

    override val fields:List<FieldInfo<SuspendMapRemoveRequest<*,*>, *>> = listOf()

    override fun construct(map: Map<String, Any?>): SuspendMapRemoveRequest<Any?, kotlin.Any> = throw NotImplementedError()
